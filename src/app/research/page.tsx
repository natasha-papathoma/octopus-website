...
const workPackages = [
  ...
  { id: "WP2", title: "Concept, Methodology & E-book", dates: "Sept 2025 – Oct 2026 · Led by Rogers Foundation", desc: "Revise the Octopus framework (eras, aspects, keywords), write the e-book in four languages, create the toolmakers' guide, and pilot with 10–15 teachers per country.", color: "bg-green text-purple-dark", status: "Ongoing", statusBg: "bg-green/15 text-green-dark" },
  { id: "WP3", title: "Game Engagement Planning", dates: "Sept 2025 – Nov 2026 · Led by Centre for Systems Solutions", desc: "Design the gamification framework, UI/UX planning, create templates and challenges for teachers and students, set up the project website.", color: "bg-blue", status: "Ongoing", statusBg: "bg-blue/10 text-blue" },
