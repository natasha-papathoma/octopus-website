    ...
    <>
      ...
      <section className="px-12 py-24 max-w-[1300px] mx-auto">
        ...
        <div className="text-base text-text-mid leading-relaxed max-w-[800px] space-y-4">
          <p>The Octopus E-book is the foundational publication, a guidebook clarifying the concept and methodologies for teachers and students working independently.</p>
